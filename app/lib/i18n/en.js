...
const en = {
  ...
  'signup.subtitle': 'Sign in or create your account.',
  'signup.continue': 'Continue',
  'signup.useEmail': 'Continue with email instead',
  'signup.usePhone': 'Continue with phone instead',
  'signup.wrongPassword': 'Incorrect password for this account.',
  ...
  'signup.methodEmail': 'Email',
  'signup.methodPhone': 'Phone',
  'signup.phone': 'Mobile number',
  'signup.phonePlaceholder': '912 345 6789',
  'signup.phoneHint': "Iran only. You'll get a code by SMS.",
  'signup.phoneInvalid': 'Enter a valid Iranian mobile number.',
  'signup.sendCode': 'Send code',
  'signup.otpSent': 'We sent a code to your phone by SMS.',
  'signup.code': 'Verification code',
  'signup.codePlaceholder': '6-digit code',
  'signup.verify': 'Verify & continue',
  'signup.resend': 'Resend code',
  'signup.changeNumber': 'Change number',
  ...
  'journal.tabDaily': 'Daily question',
  'journal.tabFree': 'Free writing',
  'journal.freeTitle': 'Free writing',
  'journal.freeSubtitle': 'A space for whatever is on your mind — no prompt, no pressure.',
  'journal.freePlaceholder': 'Write freely…',
  'journal.freeSave': 'Save',
  'journal.freeSaved': '✓ Saved',
